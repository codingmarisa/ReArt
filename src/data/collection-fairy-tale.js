import aladdin from '../assets/collections/fairy-tale-illustrations/aladdin-and-the-wonderful-lamp-474x600.jpg';
import beautyAndBeast from '../assets/collections/fairy-tale-illustrations/beauty-and-the-beast-472x600.jpg';
...
import redRidingHood from '../assets/collections/fairy-tale-illustrations/little-red-riding-hood-475x600.jpg';
import sleepingBeauty from '../assets/collections/fairy-tale-illustrations/the-sleeping-beauty-474.jpg';
import snowWhite from '../assets/collections/fairy-tale-illustrations/snow-white-and-the-seven-dwarfs-475x600.jpg';
import threeBears from '../assets/collections/fairy-tale-illustrations/the-three-bears-473x600.jpg';
...
const collectionFairyTale = {
  ...
  items: [
    ...
    {
      title: 'Beauty And The Beast (1920)',
      credit: 'Elizabeth Tyler Wolcott (American, 1892-1952)',
      image: beautyAndBeast,
      alt: 'Illustration for Beauty And The Beast',
    },
    {
      title: 'Snow White And The Seven Dwarfs (1920)',
      credit: 'Elizabeth Tyler Wolcott (American, 1892-1952)',
      image: snowWhite,
      alt: 'Illustration for Snow White And The Seven Dwarfs',
    },
    {
      title: 'The Three Bears (1918)',
      credit: 'Elizabeth Tyler Wolcott (American, 1892-1952)',
      image: threeBears,
      alt: 'Illustration for The Three Bears',
    },
    {
      title: 'Aladdin And The Wonderful Lamp (1920)',
      credit: 'Elizabeth Tyler Wolcott (American, 1892-1952)',
      image: aladdin,
      alt: 'Illustration for Aladdin And The Wonderful Lamp',
    },
    {
      title: 'Little Red Riding Hood (1919)',
      credit: 'Elizabeth Tyler Wolcott (American, 1892-1952)',
      image: redRidingHood,
      alt: 'Illustration for Little Red Riding Hood',
    },
    {
      title: 'The Sleeping Beauty (1919)',
      credit: 'Elizabeth Tyler Wolcott (American, 1892-1952)',
      image: sleepingBeauty,
      alt: 'Illustration for The Sleeping Beauty',
    },
  ],
};
